...
const UserSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["pending", "active", "rejected", "baja"],
      default: "pending",
    },
    ...
    grintScoreHistory: { type: [mongoose.Schema.Types.Mixed], default: [] },
    grintScoreHistorySyncedAt: { type: Date },
    grintLastScoreAt: { type: Date },
    gmlLastRoundAt: { type: Date },
    grintDaysOutOfDate: { type: Number },
